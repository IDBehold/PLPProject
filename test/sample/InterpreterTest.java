...
public class InterpreterTest {
    ...
    @Test
    public void createCommands_correctCommandParameterCount() {
        List<String> commands = interpreter.splitIntoCommands("(function (12 12) (35))\n(test (1 2) (2 99) (text))(foo (1) (2) (3))");
...
//        List<String> commands = interpreter.splitIntoCommands("(function (12 13) 35)\n(test (1 2) (2 99) text)(foo 1 2 3)");
//        List<Command> commandList = interpreter.createCommands(commands);
...
//        Assert.assertEquals("1", commandList.get(1).getParameters().get(0));
//        Assert.assertEquals("2", commandList.get(1).getParameters().get(1));
//        Assert.assertEquals("2", commandList.get(1).getParameters().get(2));
//        Assert.assertEquals("99", commandList.get(1).getParameters().get(3));
//        Assert.assertEquals("text", commandList.get(1).getParameters().get(4));
//        Assert.assertEquals("1", commandList.get(2).getParameters().get(0));
//        Assert.assertEquals("2", commandList.get(2).getParameters().get(1));
//        Assert.assertEquals("3", commandList.get(2).getParameters().get(2));
//    }
